...
type StorageConfig struct {
	IPFSEndpoint     string `mapstructure:"ipfs_endpoint" yaml:"ipfs_endpoint" json:"ipfs_endpoint"`
	FilecoinEndpoint string `mapstructure:"filecoin_endpoint" yaml:"filecoin_endpoint" json:"filecoin_endpoint"`
	DataDir          string `mapstructure:"data_dir" yaml:"data_dir" json:"data_dir"`
	CacheSize        int64  `mapstructure:"cache_size" yaml:"cache_size" json:"cache_size"`
}
