...
func TestNewOrchestrator(t *testing.T) {
	...
	t.Run("Default options", func(t *testing.T) {
		orchestrator, err := process.NewOrchestrator(configManager)
		require.NoError(t, err)
	...
	t.Run("Invalid services directory", func(t *testing.T) {
		...
		orchestrator, err := process.NewOrchestrator(invalidConfigManager)
		assert.Error(t, err)
...
func TestDiscoverServices(t *testing.T) {
	...
	t.Run("Empty services directory", func(t *testing.T) {
		...
		// Create orchestrator
		orch, err := process.NewOrchestrator(
			configManager,
			process.WithLogger(zaptest.NewLogger(t)),
		)
		require.NoError(t, err)
